...
class CheckpointExists(DockerException):
    def __init__(self, name, container_id):
        self.name = name
        self.container_id = container_id

    def __str__(self):
        return f"checkpoint '{self.name}' already exists for container '{self.container_id}'"


class CheckpointNotFound(DockerException):
    def __init__(self, name, container_id):
        self.name = name
        self.container_id = container_id

    def __str__(self):
        return f"checkpoint '{self.name}' not found for container '{self.container_id}'"
