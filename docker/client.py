...
from .models.checkpoint import CheckpointCollection
...
class DockerClient:
    ...
    def checkpoints(self):
        """
        An object for managing checkpoints on the server. See the
        :doc:`checkpoints documentation <checkpoints>` for full details.
        """
        return CheckpointCollection(client=self)
